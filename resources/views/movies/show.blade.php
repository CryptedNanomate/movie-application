            ...
            <div class="md:ml-24">
               ...
               <div class="flex flex-wrap items-center text-gray-400 text-sm">
                       <i class="fas fa-star text-yellow-500 mt-4"></i>
                           <span class="ml-1 mt-4">{{ $movie['vote_average']  }}</span>
                            <span class="mx-2 mt-4"> | </span>
                            <span class="mt-4">{{ $movie['release_date']  }}</span>
                            <span class="mx-2 mt-4"> | </span>
                            <span class="mt-4">
                            {{$movie['genres']}}
                            </span>
                ...
                <div class="mt-12">
                    <button 
                    @click="isOpen = true"
                    href= "https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex item-center bg-yellow-500 text-gray-900 rounded font-semibold px-5 py-4 hover:bg-yellow-600 transition ease-in-out duration-150">
